...
namespace Proj.Areas.Identity.Pages.Account
{
    ...
    public class AdminRegister : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Proj.Models.User { UserName = Input.UserName, Email = Input.Email, Age = Input.Age, PhoneNumber = Input.PhoneNum, Gender = Input.Gender };
